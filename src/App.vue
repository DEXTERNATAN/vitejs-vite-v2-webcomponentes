...
const erroConfirmaSenha = ref(false);
const erroEstado = ref(false);
const erroTermos = ref(false);
...
watch(() => form.value.senha, (newVal) => {
  if (newVal.length >= 8) {
    erroSenha.value = false;
    // Se a senha mudou, verificar também a confirmação
    if (form.value.confirmaSenha && newVal === form.value.confirmaSenha) {
      erroConfirmaSenha.value = false;
    }
  }
});

watch(() => form.value.confirmaSenha, (newVal) => {
  if (newVal === form.value.senha) {
    erroConfirmaSenha.value = false;
  }
});

// Watcher específico para o estado - corrigido
watch(() => form.value.estado, (newVal) => {
  if (newVal && newVal !== '') {
    erroEstado.value = false;
  }
}, { immediate: true }); // Adicionamos immediate: true para tratar o valor inicial

watch(() => form.value.termos, (newVal) => {
  if (newVal) {
...
const cadastrarUsuario = async () => {
  // Resetar todos os estados de erro
  ...
  } else if (form.value.senha.length < 8) {
    erroSenha.value = true;
  }

  // Validação da confirmação de senha
  if (form.value.senha !== form.value.confirmaSenha) {
    erroConfirmaSenha.value = true;
  }

  // Validação do estado
  if (!form.value.estado) {
    erroEstado.value = true;
  }

  // Validação dos termos
  if (!form.value.termos) {
    erroTermos.value = true;
  }

  // Verificar se há erros
  if (erroNome.value || erroEmail.value || erroSenha.value ||
    erroConfirmaSenha.value || erroEstado.value || erroTermos.value) {
            ...
            <div class="main-content-showcase pt-4 px-sm-3">
              ...
              <div class="card mb-5 shadow-sm" id="avatar">
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <br-message state="danger" message="Erro na dimensao do ícone quando utilizado com o button cirle"
                    is-feedback show-icon class="ms-auto message-feedback-compact"></br-message>
                </div>
                <div class="card-body">
                  <p class="card-text">
                  ...
                  <p class="card-text">
                    <small>Demonstração dos tipos <code>src</code>,
                      <code>isIconic</code>, e <code>text</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-avatar src="https://picsum.photos/id/1062/80" density="medium"
                      alt="Foto de perfil (mulher com câmera)" title="Tipo: src (Imagem)"></br-avatar>
                    <br-avatar is-iconic density="medium" alt="Ícone de usuário genérico"
                      title="Tipo: isIconic (Ícone)"></br-avatar>
                    <br-avatar text="DG" density="medium" alt="Iniciais DG" title="Tipo: text (Letra)"></br-avatar>
                  </div>
                  <h3 class="h6 mt-4">
                    2. Variações de Densidade (Tipo: Imagem)
                  </h3>
                  <p class="card-text">
                    <small>Mostra o efeito de <code>density</code> (small, medium,
                      large) em um avatar com imagem.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-avatar src="https://picsum.photos/id/1062/80" density="small"
                      alt="Foto de perfil (mulher com câmera) - Pequeno" title="Densidade: small"></br-avatar>
                    <br-avatar src="https://picsum.photos/id/1062/80" density="medium"
                      alt="Foto de perfil (mulher com câmera) - Médio" title="Densidade: medium"></br-avatar>
                    <br-avatar src="https://picsum.photos/id/1062/80" density="large"
                      alt="Foto de perfil (mulher com câmera) - Grande" title="Densidade: large"></br-avatar>
                  </div>
                  ...
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-avatar text="OK" density="medium" alt="Avatar habilitado (Letra OK)"
                      title="Habilitado"></br-avatar>
                    <br-avatar text="OK" density="medium" disabled alt="Avatar desabilitado (Letra OK)"
                      title="Desabilitado (disabled)"></br-avatar>
                    <br-avatar is-iconic density="medium" disabled alt="Ícone desabilitado"
                      title="Ícone Desabilitado"></br-avatar>
                  </div>
                  <h3 class="h6 mt-4">4. Ajustes no Tipo Ícone</h3>
                  <p class="card-text">
                    <small>Demonstra o uso de <code>icon-width</code> e
                      <code>icon-height</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-avatar is-iconic density="large" alt="Ícone Padrão (Grande)"
                      title="Padrão (density=large)"></br-avatar>
                    <br-avatar is-iconic density="large" icon-width="32px" icon-height="32px"
                      alt="Ícone com 32px (dentro de avatar grande)" title="icon-width/height='32px'"></br-avatar>
                    <br-avatar is-iconic density="large" icon-width="16px" icon-height="16px"
                      alt="Ícone com 16px (dentro de avatar grande)" title="icon-width/height='16px'"></br-avatar>
                  </div>
                  <p class="card-text mt-3">
                    <small><em>Nota: <code>iconMarginTop</code> também pode ser usado
                        para ajustes verticais finos do ícone.</em></small>
                  </p>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="button">
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <br-message state="success" message="Componente OK" is-feedback show-icon
                    class="ms-auto message-feedback-compact"></br-message>
                </div>
                <div class="card-body">
                  <p class="card-text">
                  ...
                  <p class="card-text">
                    <small>Mostra os atributos <code>emphasis</code> e
                      <code>type</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-button emphasis="primary" density="medium">Primário (button)</br-button>
                    <br-button emphasis="secondary" density="medium">Secundário (button)</br-button>
                    <br-button emphasis="tertiary" density="medium">Terciário (button)</br-button>
                    <br-button emphasis="primary" type="submit" density="medium">Enviar (submit)</br-button>
                    <br-button emphasis="secondary" type="reset" density="medium">Limpar (reset)</br-button>
                  </div>
                  <h3 class="h6 mt-4">
                    3. Exemplos de Estados e Modo (Densidade Média)
                  </h3>
                  <p class="card-text">
                    <small>Mostra os estados <code>disabled</code>,
                      <code>isLoading</code>, <code>isActive</code> e o modo
                      <code>colorMode="dark"</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-button emphasis="primary" density="medium" disabled>Desabilitado</br-button>
                    <br-button emphasis="primary" density="medium" is-loading>Carregando</br-button>
                    <br-button emphasis="secondary" density="medium" is-active>Ativo</br-button>
                  </div>

                  <div class="d-flex flex-wrap justify-content-evenly align-items-center bg-dark p-3 border mt-3 gap-4">
                    <br-button emphasis="primary" density="medium" color-mode="dark">Modo Escuro</br-button>
                    <br-button emphasis="secondary" density="medium" color-mode="dark" class="ms-3">Modo
                      Escuro</br-button>
                  </div>
                  <h3 class="h6 mt-4">
                  ...
                  <p class="card-text">
                    <small>Mostra o atributo <code>shape</code> (pill, circle,
                      block).</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-button emphasis="primary" density="medium" shape="pill">Formato Pill</br-button>
                    <br-button emphasis="secondary" density="medium" shape="circle" aria-label="Formato Círculo">
                      <br-icon icon-name="fa6-solid:heart"></br-icon>
                    </br-button>
                    <br-button emphasis="secondary" density="medium">Formato Padrão</br-button>
                  </div>
                  <p class="card-text mt-3">
                    <small>O formato <code>block</code> ocupa toda a largura
                      disponível do container.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    <br-button emphasis="primary" density="medium" shape="block">Botão Block (Ocupa Largura)</br-button>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="breadcrumb">
                ...
                <div class="card-body">
                  <p class="card-text">
                    ...
                    formato
                    <code>[{ label: string, url: string, active?: boolean, target?:
                      string }]</code>. O <code>target</code> (ex: '_self', '_blank') define onde
                  ...
                  <div class="p-3 border rounded mt-2 overflow-auto">
                    <br-breadcrumb aria-label="Navegação Estrutural Longa" home-url="/dashboard" crumbs='[
                  ...
                  <div class="p-3 border rounded mt-2 overflow-auto">
                    <br-breadcrumb aria-label="Navegação Estrutural com Home Padrão" crumbs='[
              ...
              <div class="card mb-5 shadow-sm" id="checkbox">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small>Demonstra <code>checked</code> e
                      <code>disabled</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-start align-items-center p-3 border rounded mt-2 gap-4">
                    <br-checkbox name="basic-states-ck" label="Padrão"></br-checkbox>
                    <br-checkbox name="basic-states-ck" label="Marcado" checked></br-checkbox>
                    <br-checkbox name="basic-states-ck" label="Desabilitado" disabled></br-checkbox>
                    <br-checkbox name="basic-states-ck" label="Marcado Desabilitado" checked disabled></br-checkbox>
                  </div>
                  <h3 class="h6 mt-4">2. Estados Indeterminado e Validação</h3>
                  <p class="card-text">
                    <small>Demonstra <code>indeterminate</code> e
                      <code>state</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-start align-items-center p-3 border rounded mt-2 gap-4">
                    <br-checkbox name="inter-valid-states-ck" label="Indeterminado" indeterminate></br-checkbox>
                    <br-checkbox name="inter-valid-states-ck" label="Válido" checked state="valid"></br-checkbox>
                    <br-checkbox name="inter-valid-states-ck" label="Inválido" state="invalid"></br-checkbox>
                  </div>
                  <h3 class="h6 mt-4">3. Visibilidade e Conteúdo do Label</h3>
                  <p class="card-text">
                    <small>Demonstra <code>hasHiddenLabel</code> e uso de slot para
                      label.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-start align-items-center p-3 border rounded mt-2 gap-4">
                    <br-checkbox name="label-vis-slot-ck" has-hidden-label
                      aria-label="Checkbox com Label Oculto"></br-checkbox>
                  ...
                  <p class="card-text mt-3">
                    <small><em>Nota: O atributo <code>value</code> é usado para envio
                        em formulários, não afeta a aparência.
                        <code>name</code> é obrigatório.</em></small>
                  </p>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="p-3 border rounded mt-2">
                    <br-checkgroup label="Opções Disponíveis (Padrão)">
                      <br-checkbox name="cg-default" label="Item 1" class="mb-1"></br-checkbox>
                      <br-checkbox name="cg-default" label="Item 2" class="mb-1"></br-checkbox>
                  ...
                  <p class="card-text">
                    <small>Textos do master control alterados e um item
                      pré-selecionado.</small>
                  </p>
                  <div class="p-3 border rounded mt-2">
                    <br-checkgroup label="Minhas Tarefas (Custom)" label-selecionado="Desmarcar Tarefas"
                      label-desselecionado="Marcar Tarefas">
                      <br-checkbox name="cg-custom" label="Tarefa A" class="mb-1"></br-checkbox>
                      <br-checkbox name="cg-custom" label="Tarefa B" class="mb-1" checked></br-checkbox>
                      <br-checkbox name="cg-custom" label="Tarefa C"></br-checkbox>
                    </br-checkgroup>
                  </div>
                  <h3 class="h6 mt-4">3. Estado Indeterminado Forçado</h3>
                  <p class="card-text">
                    <small>Usando o atributo <code>indeterminate</code> no
                      grupo.</small>
                  </p>
                  <div class="p-3 border rounded mt-2">
                    <br-checkgroup label="Seleção Parcial (Forçada)" indeterminate>
                      <br-checkbox name="cg-indet" label="Opção X" class="mb-1"></br-checkbox>
                      <br-checkbox name="cg-indet" label="Opção Y" class="mb-1"></br-checkbox>
                      <br-checkbox name="cg-indet" label="Opção Z"></br-checkbox>
                    </br-checkgroup>
                  </div>
                  <p class="card-text mt-3">
                    <small><em>Nota: A aparência do estado indeterminado no controle
              ...
              <div class="card mb-5 shadow-sm" id="collapse">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small>Sem <code>accordion-group</code>, cada um abre/fecha
                      livremente.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
                  ...
                  <p class="card-text">
                    <small>Demonstra <code>icon-position</code> e ícones
                      customizados.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    ...
                    <br-collapse icon-to-show="fa6-solid:plus" icon-to-hide="fa6-solid:minus">
              ...
              <div class="card mb-5 shadow-sm" id="divider">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small>Mostra <code>orientation</code> e
                  ...
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    ...
                    <div class="d-flex align-items-center mt-3" style="height: 40px">
                      <span>Item A</span>
                      <br-divider orientation="vertical" thickness="medium" class="mx-3"></br-divider>
                      <span>Item B (Vertical Médio)</span>
                    </div>
                  </div>
                  <h3 class="h6 mt-4">2. Estilo da Borda, Cor e Modo Escuro</h3>
                  <p class="card-text">
                    <small>Mostra <code>borderStyle</code>, <code>color</code> e
                  ...
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    ...
                    <span>Adaptação Modo Escuro (Ver no Inspecionar/Fundo
                      Escuro)</span>
                  ...
                  <p class="card-text">
                    <small>O atributo <code>align</code> funciona quando há texto
              ...
              <div class="card mb-5 shadow-sm" id="dropdown">
                ...
                <div class="card-body">
                  ...
                  <div class="p-3 border rounded mt-2 bg-lightest d-flex justify-content-center">
                    <br-dropdown>
                      <br-button slot="trigger" shape="circle" aria-label="Abrir menu de opções">
                  ...
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    <br-dropdown is-open>
                      <br-button slot="trigger">Menu Inicialmente Aberto
                        <br-icon icon-name="fa6-solid:caret-up"></br-icon></br-button>
                      <br-list slot="target">
                  ...
                  <p class="card-text">
                    <small>Um botão externo controla o estado aberto/fechado do
                      dropdown.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
              ...
              <div class="card mb-5 shadow-sm" id="icon">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small>Demonstra o padrão e tamanhos customizados com
                      <code>width</code> e <code>height</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-icon icon-name="fa6-solid:house" alt="Ícone Casa (Tamanho Padrão)"
                      title="Padrão (w:24, h:16)"></br-icon>
                    <br-icon icon-name="fa6-solid:star" width="32" height="32" alt="Ícone Estrela (32x32)"
                      title="w:32, h:32"></br-icon>
                    <br-icon icon-name="fa6-solid:heart" height="40" alt="Ícone Coração (Altura 40px)"
                      title="h:40"></br-icon>
                    <br-icon icon-name="fa6-solid:gear" width="40" alt="Ícone Engrenagem (Largura 40px)"
                      title="w:40"></br-icon>
                  </div>
                  <h3 class="h6 mt-4">2. Rotação e Espelhamento</h3>
                  <p class="card-text">
                    <small>Demonstra os atributos <code>rotate</code> e
                      <code>flip</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-icon icon-name="fa6-solid:arrow-right" alt="Seta Direita" title="Normal"></br-icon>
                    <br-icon icon-name="fa6-solid:arrow-right" rotate="90deg" alt="Seta Rotacionada 90°"
                      title="rotate='90deg'"></br-icon>
                    <br-icon icon-name="fa6-solid:arrow-right" rotate="180deg" alt="Seta Rotacionada 180°"
                      title="rotate='180deg'"></br-icon>
                    <br-icon icon-name="fa6-solid:arrow-right" rotate="270deg" alt="Seta Rotacionada 270°"
                      title="rotate='270deg'"></br-icon>
                    <br-icon icon-name="fa6-solid:truck" flip="horizontal" alt="Caminhão Espelhado H."
                      title="flip='horizontal'"></br-icon>
                    <br-icon icon-name="fa6-solid:plane" flip="vertical" alt="Avião Espelhado V."
                      title="flip='vertical'"></br-icon>
                  </div>
                  <h3 class="h6 mt-4">3. Alinhamento Inline e Estilo</h3>
                  <p class="card-text">
                    <small>Demonstra <code>isInline</code> para alinhar com texto e
                      <code>cssClasses</code> para estilo.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    <p class="mb-1">
                      Texto com ícone
                      <br-icon icon-name="fa6-regular:comment-dots" alt="Comentário"></br-icon>
                      padrão.
                    </p>
                    <p>
                      Texto com ícone
                      <br-icon icon-name="fa6-regular:comment-dots" is-inline alt="Comentário"></br-icon>
                      alinhado (<code>isInline</code>).
                    </p>
                    <hr class="my-2" />
                    <p>
                      Ícone com classe CSS:
                      <br-icon icon-name="fa6-brands:vuejs" css-classes="meu-icone-colorido"
                        alt="Ícone Vue.js com Classe CSS" title="css-classes='meu-icone-colorido'"></br-icon>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="input">
                ...
                <div class="card-body">
                  ...
                  <div class="p-3 border rounded mt-3 d-flex flex-column gap-3">
                    <br-input id="input-small-density-i-full" label="Input Pequeno" placeholder="Densidade: small"
                      density="small"></br-input>
                    <br-input id="input-medium-density-i-full" label="Input Médio" placeholder="Densidade: medium"
                      density="medium"></br-input>
                    <br-input id="input-large-density-i-full" label="Input Grande" placeholder="Densidade: large"
                      density="large"></br-input>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="item">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small>Mostra <code>density</code> (small, medium,
                      large).</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-1 bg-lightest">
                    <br-item density="small"><br-icon slot="start" icon-name="fa6-solid:compress"></br-icon>Item
                      Pequeno<span slot="end">S</span></br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item density="medium"><br-icon slot="start"
                        icon-name="fa6-solid:arrows-left-right"></br-icon>Item Médio<span slot="end">M</span></br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item density="large"><br-icon slot="start" icon-name="fa6-solid:expand"></br-icon>Item
                      Grande<span slot="end">L</span></br-item>
                  </div>
                  <h3 class="h6 mt-4">2. Comportamento de Link (`href`)</h3>
                  <p class="card-text">
                    <small>Demonstra <code>href</code>, <code>target</code> e
                      <code>isInteractive</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-1 bg-lightest">
                    <br-item href="#link-simples"><br-icon slot="start" icon-name="fa6-solid:link"></br-icon>Item Link
                      Simples</br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item href="#link-interativo" is-interactive><br-icon slot="start"
                        icon-name="fa6-solid:hand-pointer"></br-icon>Item Link Interativo (Área Clicável)</br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item href="https://www.google.com" target="_blank" is-interactive><br-icon slot="start"
                        icon-name="fa6-solid:external-link-alt"></br-icon>Abrir Google em Nova Aba
                      (target="_blank")</br-item>
                  </div>
                  <h3 class="h6 mt-4">
                    3. Comportamento de Botão (`isButton`)
                  </h3>
                  <p class="card-text">
                    <small>Demonstra <code>isButton</code>, <code>type</code> e
                      <code>isInteractive</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-1 bg-lightest">
                    <br-item is-button><br-icon slot="start" icon-name="fa6-regular:hand-point-up"></br-icon>Item Botão
                      Simples (sem isInteractive)</br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item is-button is-interactive><br-icon slot="start"
                        icon-name="fa6-solid:mouse-pointer"></br-icon>Item Botão Interativo (Área Clicável)</br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item is-button is-interactive type="submit"><br-icon slot="start"
                        icon-name="fa6-solid:paper-plane"></br-icon>Enviar Formulário (type="submit")</br-item>
                    <p class="mt-2 mb-0">
                      <small><em>Nota: Use <code>type="reset"</code> ou
                  ...
                  <p class="card-text">
                    <small>Demonstra <code>disabled</code>,
                      <code>isSelected</code> e <code>isActive</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-1 bg-lightest">
                    <br-item disabled><br-icon slot="start" icon-name="fa6-solid:ban"></br-icon>Item
                      Desabilitado</br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item is-selected is-interactive><br-icon slot="start"
                        icon-name="fa6-solid:check-square"></br-icon>Item Selecionado</br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item is-active is-interactive><br-icon slot="start" icon-name="fa6-solid:star"></br-icon>Item
                      Ativo</br-item>
                    <br-divider class="my-1"></br-divider>
                    <br-item is-selected disabled><br-icon slot="start"
                        icon-name="fa6-solid:check-square"></br-icon>Item Selecionado e Desabilitado<span
                        slot="end">(Exemplo)</span></br-item>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="loading">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-5">
                    <br-loading title="Tamanho Padrão"></br-loading>
                    <br-loading label="Processando..." title="Padrão com Label"></br-loading>
                    <br-loading is-medium label="Aguarde (médio)..." title="Médio com Label"></br-loading>
                  </div>
                  <h3 class="h6 mt-4">2. Barra de Progresso (`isProgress`)</h3>
                  <p class="card-text">
                    <small>Demonstra <code>progressPercent</code> e label.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-loading is-progress progress-percent="0" label="Iniciando... 0%"></br-loading>
                    <br-loading is-progress progress-percent="65" label="Carregando dados... 65%"></br-loading>
                    <br-loading is-progress progress-percent="100" label="Concluído!"></br-loading>
              ...
              <div class="card mb-5 shadow-sm" id="message">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small>Demonstra estados, título, ícone, fechamento e layout
                      inline.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-message state="info" message-title="Informação" message="Esta é uma mensagem informativa."
                      show-icon></br-message>
                    <br-message state="success" message-title="Sucesso!" message="Operação concluída com êxito."
                      show-icon></br-message>
                    <br-message state="warning" message-title="Atenção!" message="Verifique os dados inseridos."
                      show-icon></br-message>
                    <br-message state="danger" message-title="Erro!" message="Falha ao processar a solicitação."
                      show-icon></br-message>
                    <hr />
                    <br-message state="success" message-title="Fechável" message="Clique no X para fechar (não remove)."
                      is-closable show-icon></br-message>
                    <br-message state="warning" message-title="Fechável (Auto Remove)"
                      message="Clique no X para fechar (remove do DOM)." is-closable auto-remove show-icon></br-message>
                    <br-message state="info" message-title="Título Inline:" message="A mensagem aparece ao lado."
                      is-inline show-icon></br-message>
                  </div>
                  <h3 class="h6 mt-4">
                    2. Mensagens de Feedback (`isFeedback`)
                  </h3>
                  <p class="card-text">
                    <small>Estilo para validação de formulários (sem título,
                      fechamento ou inline).</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-message state="info" message="Formato esperado: DD/MM/AAAA." is-feedback show-icon></br-message>
                    <br-message state="success" message="Campo válido." is-feedback show-icon></br-message>
                    <br-message state="warning" message="Caps Lock ativo." is-feedback show-icon></br-message>
                    <br-message state="danger" message="CPF inválido." is-feedback show-icon></br-message>
                    <br-message state="danger" message="Campo obrigatório (sem ícone)." is-feedback></br-message>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="radio">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <small>Demonstra grupo com <code>name</code>,
                      <code>value</code>, <code>checked</code> e
                      <code>disabled</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    <p class="label mb-2">Selecione uma Fruta:</p>
                    <br-radio name="fruta" value="laranja" label="Laranja" class="mb-1"></br-radio>
                    <br-radio name="fruta" value="maca" label="Maçã" checked class="mb-1"></br-radio>
                    <br-radio name="fruta" value="uva" label="Uva (Desabilitado)" disabled class="mb-1"></br-radio>
                    <br-radio name="fruta" value="banana" label="Banana" class="mb-1"></br-radio>
                  </div>
                  <h3 class="h6 mt-4">2. Estados de Validação</h3>
                  <p class="card-text">
                    <small>Demonstra os atributos <code>state="valid"</code> e
                      <code>state="invalid"</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    <p class="label mb-2">Status da Seleção:</p>
                    <br-radio name="status-valid" value="valido" label="Seleção Válida" state="valid"
                      class="mb-1"></br-radio>
                    <br-radio name="status-valid" value="invalido" label="Seleção Inválida" state="invalid" checked
                      class="mb-1"></br-radio>
                    <br-radio name="status-valid" value="normal" label="Seleção Normal" class="mb-1"></br-radio>
                  </div>
                  <h3 class="h6 mt-4">3. Opções de Label</h3>
                  <p class="card-text">
                    <small>Demonstra <code>hasHiddenLabel</code> (requer
                      <code>aria-label</code>) e label via slot.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-start align-items-center p-3 border rounded mt-2 gap-4">
                    <br-radio name="label-opts" value="hidden" has-hidden-label
                      aria-label="Opção com Label Oculto"></br-radio>
                    <span>(Label Oculto)</span>
                  ...
                  <p class="card-text mt-3">
                    <small><em>Nota: O atributo <code>value</code> define o valor
                        enviado pelo formulário para a opção selecionada dentro
                        do grupo <code>name</code>.</em></small>
                  </p>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="select">
                ...
                <div class="card-body">
                  ...
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-select id="select-small-density-rev" label="Select Pequeno (Dados via string)"
                      placeholder="Densidade: small" density="small"
                      options='[{ "label": "Opção S1", "value": "s1" }, { "label": "Opção S2", "value": "s2" }]'></br-select>
                    <br-select id="select-medium-density-rev" label="Select Médio (Dados via string)"
                      placeholder="Densidade: medium" density="medium"
                      options='[{ "label": "Opção M1", "value": "m1" }, { "label": "Opção M2", "value": "m2" }]'></br-select>
                    <br-select id="select-large-density-rev" label="Select Grande (Dados via Object Array)"
                      placeholder="Densidade: large" density="large" :options="estadosOptionsString"></br-select>
                  </div>
                  <h3 class="h6 mt-4">2. Seleção Múltipla (`isMultiple`)</h3>
                  <p class="card-text">
                    <small>Permite selecionar vários itens. Mostra labels padrão e
                      customizados.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-select id="select-multi-default" is-multiple label="Múltipla Escolha (Labels Padrão)"
                      placeholder="Selecione um ou mais" options='[
                                  { "label": "Opção A", "value": "a", "selected": true },
                                  { "label": "Opção B", "value": "b" },
                                  { "label": "Opção C", "value": "c", "selected": true }
                                ]'></br-select>
                    <br-select id="select-multi-custom" is-multiple label="Múltipla Escolha (Labels Custom)"
                      select-all-label="Marcar Todos" unselect-all-label="Limpar Seleção"
                      placeholder="Selecione um ou mais" options='[
                  ...
                  <p class="card-text">
                    <small>Demonstra <code>showSearchIcon</code> e
                      <code>is-open</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-select id="select-search-icon" label="Com Ícone de Busca" show-search-icon
                      placeholder="Busca visual" options='[{ "label": "Opção 1", "value": "1" }]'></br-select>
                    <br-select id="select-start-open" label="Iniciando Aberto" is-open placeholder="Selecione"
                      options='[{ "label": "Opção Visível", "value": "vis" }]'></br-select>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="switch">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-switch name="density-sw" density="small" label="Pequeno"></br-switch>
                    <br-switch name="density-sw" density="medium" label="Médio (padrão)"></br-switch>
                    <br-switch name="density-sw" density="large" label="Grande"></br-switch>
                  </div>
                  ...
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    ...
                    <br-switch name="state-sw-rev" label="Desabilitado (Off)" disabled></br-switch>
                    <br-switch name="state-sw-rev" label="Desabilitado (On)" checked disabled></br-switch>
                  </div>
                  <h3 class="h6 mt-4">3. Ícone Interno e Labels Dinâmicos</h3>
                  <p class="card-text">
                    <small>Demonstra <code>hasIcon</code>, <code>labelOn</code> e
                      <code>labelOff</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-4">
                    <br-switch name="icon-onoff-sw" label="Com Ícone" has-icon></br-switch>
                    <br-switch name="icon-onoff-sw" label="Com Ícone (Ligado)" has-icon checked></br-switch>
                    <br-switch name="icon-onoff-sw" label="Status" label-on="Ativo" label-off="Inativo"></br-switch>
                    <br-switch name="icon-onoff-sw" label="Status (Ligado)" label-on="SIM" label-off="NÃO"
                      checked></br-switch>
                  </div>
                  ...
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-switch name="pos-sw-rev" label="Label à Esquerda (Padrão)" label-position="left"></br-switch>
                    <br-switch name="pos-sw-rev" label="Label à Direita" label-position="right"></br-switch>
                    <br-switch name="pos-sw-rev" label="Label Acima" label-position="top"></br-switch>
                  </div>
                  <p class="card-text mt-3">
                    <small><em>Nota: <code>name</code> é obrigatório para uso em
              ...
              <div class="card mb-5 shadow-sm" id="tag">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-3">
                  ...
                  <p class="card-text">
                    <small>Demonstra diferentes classes de <code>color</code> e uso
                      de <code>icon-name</code>.</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-3">
                    <br-tag density="medium" color="bg-success" label="Sucesso"></br-tag>
                    <br-tag density="medium" color="bg-warning text-dark" label="Aviso"></br-tag>
                    <br-tag density="medium" color="bg-danger" label="Erro"></br-tag>
                    <br-tag density="medium" color="bg-info" label="Info"></br-tag>
                    <br-tag density="medium" color="bg-primary" label="Com Ícone" icon-name="fa6-solid:star"></br-tag>
                  </div>

                  <h3 class="h6 mt-4">3. Formatos (`shape`)</h3>
                  <p class="card-text">
                    <small>Demonstra o formato padrão e
                      <code>shape="rounded"</code> (bom para contadores).</small>
                  </p>
                  <div class="d-flex flex-wrap justify-content-evenly align-items-center p-3 border rounded mt-2 gap-3">
                    <br-tag density="medium" color="bg-secondary" label="Padrão"></br-tag>
                    <br-tag density="medium" color="bg-danger" label="10" shape="rounded"></br-tag>
                    <br-tag density="medium" color="bg-danger" label="99+" shape="rounded"></br-tag>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="textarea">
                ...
                <div class="card-body">
                  ...
                  <h3 class="h6 mt-4">1. Exemplos de Densidade</h3>
                  <p class="card-text">
                    <small>Mostra <code>density="small"</code>, <code>medium</code>,
                      <code>large</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-textarea id="textarea-small-density-rev" label="Textarea Pequena" placeholder="Densidade: small"
                      density="small" rows="2"></br-textarea>
                    <br-textarea id="textarea-medium-density-rev" label="Textarea Média"
                      placeholder="Densidade: medium (padrão)" density="medium" rows="2"></br-textarea>
                    <br-textarea id="textarea-large-density-rev" label="Textarea Grande" placeholder="Densidade: large"
                      density="large" rows="2"></br-textarea>
                  </div>

                  <h3 class="h6 mt-4">2. Estados Comuns e Validação</h3>
                  <p class="card-text">
                    <small>Mostra <code>disabled</code>,
                      <code>readonly</code> (assumido) e
                      <code>state</code>.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-textarea id="textarea-state-disabled" label="Desabilitado" placeholder="Não editável" disabled
                      rows="2"></br-textarea>
                    <br-textarea id="textarea-state-readonly" label="Somente Leitura" value="Texto fixo não editável..."
                      readonly rows="2"></br-textarea>
                    <br-textarea id="textarea-state-success" label="Sucesso" state="success" value="Texto válido"
                      rows="2"></br-textarea>
                    <br-textarea id="textarea-state-danger" label="Erro" state="danger" value="Texto inválido"
                      rows="2"></br-textarea>
                    <br-textarea id="textarea-state-warning" label="Aviso" state="warning" value="Revisar este texto"
                      rows="2"></br-textarea>
                  </div>

                  <h3 class="h6 mt-4">3. Contador e Valor Inicial</h3>
                  <p class="card-text">
                    <small>Demonstra <code>showCounter</code> (com
                      <code>maxlength</code>) e
                      <code>value</code> inicial.</small>
                  </p>
                  <div class="p-3 border rounded mt-2 d-flex flex-column gap-3 bg-lightest">
                    <br-textarea id="textarea-attr-counter" label="Com Contador (max 150)" show-counter maxlength="150"
                      placeholder="Digite até 150 caracteres" rows="3"></br-textarea>
                    <br-textarea id="textarea-attr-value" label="Com Valor Inicial"
                      value="Este é um texto inicial&#10;com quebra de linha." rows="3"></br-textarea>
                  </div>

                  <h3 class="h6 mt-4">4. Layout Inline</h3>
                  <p class="card-text">
                    <small>Demonstra <code>isInline</code> (pode precisar de ajustes
                      CSS no container).</small>
                  </p>
                  <div class="p-3 border rounded mt-2 bg-lightest">
                    <br-textarea id="textarea-attr-inline" label="Label e Textarea Inline"
                      placeholder="Na mesma linha..." is-inline rows="2"></br-textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="upload">
                ...
                <div class="card-body">
                  ...
                  <div class="example-box p-3 border rounded mt-3 bg-body-tertiary">
                    <br-upload id="upload-example-s-full" label="Selecione ou arraste arquivos"
                      accept="image/*,application/pdf" :disabled="false" :multiple="false" state="info"></br-upload>
                  </div>
                  <h3 class="h6 subsection-title">
                    Exemplos com diferentes atributos
                  </h3>
                  <div class="example-box p-3 border rounded mt-3 d-flex flex-column gap-3 bg-body-tertiary">
                    <br-upload id="upload-example-multiple" label="Selecione múltiplos arquivos" accept=".txt"
                      :multiple="true" state="warning"></br-upload>
                    <br-upload id="upload-example-disabled" label="Upload desabilitado" :disabled="true"
                      state="danger"></br-upload>
                    <br-upload id="upload-example-success" label="Upload para apenas imagens" accept="image/*"
                      state="success"></br-upload>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-5 shadow-sm" id="formularios">
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <br-message state="success" message="Componente OK" is-feedback show-icon
                    class="me-3 message-feedback-compact"></br-message>
                </div>
                <br-message v-if="cadastroSucesso" state="success" message-title="Sucesso!"
                  message="Usuário cadastrado com sucesso." show-icon></br-message>
                <br-message v-if="cadastroErro" state="danger" message-title="Erro!"
                  message="Por favor, corrija os erros no formulário." show-icon></br-message>
                <div class="card-body">
                  <p class="card-text">
                    Exemplo de construção de formulário utilizando os componentes `br-*`. Este exemplo demonstra um
                  ...
                  <div class="example-box p-3 border rounded mt-3 bg-body-tertiary">
                    <form @submit.prevent="cadastrarUsuario">
                      <div class="row g-3">
                        <div class="col-md-6">
                          <br-input v-model="form.nome" id="form-nome" label="Nome Completo"
                            placeholder="Digite seu nome completo" density="medium" :state="erroNome ? 'danger' : null"
                            required></br-input>
                          <br-message v-if="erroNome" state="danger"
                            message="O nome é obrigatório e deve ter pelo menos 3 caracteres." is-feedback show-icon
                            class="mt-1"></br-message>
                        </div>
                        <div class="col-md-6">
                          <br-input v-model="form.email" id="form-email" type="email" label="Email"
                            placeholder="seuemail@dominio.com" density="medium" :state="erroEmail ? 'danger' : null"
                            required></br-input>
                          <br-message v-if="erroEmail" state="danger" message="O email é obrigatório e deve ser válido."
                            is-feedback show-icon class="mt-1"></br-message>
                        </div>
                        <div class="col-md-6">
                          <br-input v-model="form.senha" id="form-senha" type="password" label="Senha"
                            placeholder="Crie uma senha" density="medium" :state="erroSenha ? 'danger' : null"
                            required></br-input>
                          <br-message v-if="erroSenha" state="danger"
                            message="A senha é obrigatória e deve ter pelo menos 8 caracteres." is-feedback show-icon
                            class="mt-1"></br-message>
                        </div>
                        <div class="col-md-6">
                          <br-input v-model="form.confirmaSenha" id="form-confirma-senha" type="password"
                            label="Confirmar Senha" placeholder="Repita a senha" density="medium"
                            :state="erroConfirmaSenha ? 'danger' : null" required></br-input>
                          <br-message v-if="erroConfirmaSenha" state="danger" message="As senhas não coincidem."
                            is-feedback show-icon class="mt-1"></br-message>
                        </div>
                        <div class="col-md-6">
                          <br-select v-model="form.estado" id="form-estado" label="Estado"
                            placeholder="Selecione seu estado" density="medium" :options="estadosOptionsString"
                            :state="erroEstado ? 'danger' : null" required></br-select>
                          <br-message v-if="erroEstado" state="danger" message="Selecione seu estado." is-feedback
                            show-icon class="mt-1"></br-message>
                        </div>
                        <div class="col-md-6 mb-2">
                          <p class="label mb-2">Gênero:</p>
                          <div class="d-flex flex-wrap gap-3">
                            <br-radio v-model="form.genero" name="genero" value="M" label="Masculino"></br-radio>
                            <br-radio v-model="form.genero" name="genero" value="F" label="Feminino"></br-radio>
                            <br-radio v-model="form.genero" name="genero" value="O" label="Outro"></br-radio>
                            <br-radio v-model="form.genero" name="genero" value="N"
                              label="Prefiro não informar"></br-radio>
                          </div>
                        </div>
                        <div class="col-12 mb-2">
                          <br-upload id="form-foto" label="Foto de Perfil (Opcional)" accept="image/*" :multiple="false"
                            state="info"></br-upload>
                        </div>
                        <div class="col-12">
                          <br-checkbox v-model="form.termos" name="termos" label="Li e aceito os termos de uso"
                            :state="erroTermos ? 'danger' : null" required class="mb-2"></br-checkbox>
                          <br-message v-if="erroTermos" state="danger" message="Você deve aceitar os termos de uso."
                            is-feedback show-icon class="mt-1 mb-2"></br-message>
                          <br-switch v-model="form.newsletter" name="newsletter" label="Desejo receber a newsletter"
                            label-position="right"></br-switch>
                        </div>
                      </div>
