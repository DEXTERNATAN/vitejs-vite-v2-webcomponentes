...
export default {
  ...
  methods: {
    ...
    collapseItemList() {
      console.log("collapseItemList");
      const listaRef = this.$refs.ulList;
      console.log(listaRef);
      listaRef.classList.toggle("list-show");
    },

    collapseItemListDashBoard() {
      console.log("collapseItemListDashBoard");
      const listaRefDashboard = this.$refs.ulListDashboard;
      console.log(listaRefDashboard);
      listaRefDashboard.classList.toggle("list-show");
    },
  },
};
</script>
      ...
      <div class="container-fluid">
        <div class="header-top">
          <div class="header-logo">
            ...
            <div class="header-sign">Design System do Governo - Web Components 2.0</div>
          </div>
        </div>
        <div class="header-bottom">
          <div class="header-menu">
            ...
            <div class="header-info" v-if="isMenuVisible">
                ...
                <div class="col-sm d-flex">
                  <div class="br-card">
                    ...
                    <div class="card-content">
                      ...
                      eligendi eum debitis dolores magnam quod sint doloribus omnis vitae
                      placeat. Natus, minus.
                    </div>
                  </div>
                </div>
                <div class="col-sm d-flex">
                  <div class="br-card">
                    ...
                    <div class="card-content">
                      ...
                      culpa inventore mollitia vitae a nesciunt reiciendis incidunt,
                      labore repudiandae voluptate nisi. Numquam illo est maiores
                      doloribus recusandae rem inventore ea?
                    </div>
                  </div>
                </div>
                <div class="col-sm d-flex">
                  <div class="br-card">
                    ...
                    <div class="card-content">
                      ...
                      cupiditate nihil facere autem dignissimos ex beatae labore? Fuga
                      consequuntur consectetur voluptatum incidunt, tenetur, dolore magnam
                      inventore hic iusto amet ipsa.
                    </div>
                  </div>
                </div>
              </div> -->
